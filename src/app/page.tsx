        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-semibold mb-2">{t("homePage.services.truckRental")}</h3>
              <p className="text-gray-600">{t("homePage.services.truckRentalDesc")}</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-semibold mb-2">{t("homePage.services.shipping")}</h3>
              <p className="text-gray-600">{t("homePage.services.shippingDesc")}</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-semibold mb-2">{t("homePage.services.shipRental")}</h3>
              <p className="text-gray-600">{t("homePage.services.shipRentalDesc")}</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-semibold mb-2">{t("homePage.services.exportImport")}</h3>
              <p className="text-gray-600">{t("homePage.services.exportImportDesc")}</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {[
              ...
              <div key={index} className="bg-gray-50 p-4 rounded-lg border border-gray-200 flex items-center justify-center text-center">
      ...
      <section className="bg-secondary py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              href="/booking" 
              className="bg-white text-secondary px-6 py-3 rounded-md font-medium text-center hover:bg-gray-100 transition-colors"
            >
