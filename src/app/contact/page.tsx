        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10 items-stretch">
            <a href="tel:+62817726068" className="group block w-full h-full rounded-xl overflow-hidden border border-gray-200 bg-white p-4 shadow-sm hover:shadow-md transition-all">
              <div className="flex items-center gap-3 min-w-0 w-full min-h-[64px]">
                ...
                <div className="min-w-0 flex-1 basis-0 flex flex-col justify-center space-y-0.5">
                  <p className="text-sm text-gray-500">Call us</p>
                  <p className="font-medium truncate">+62 817-726068</p>
                </div>
              </div>
            </a>
            <a href="https://wa.me/62817726068" target="_blank" rel="noopener noreferrer" className="group block w-full h-full rounded-xl overflow-hidden border border-gray-200 bg-white p-4 shadow-sm hover:shadow-md transition-all leading-none">
              <div className="flex items-center gap-3 min-w-0 w-full min-h-[64px]">
            ...
            <a href="mailto:ops@prabasamudralogistics.com" className="group block w-full h-full rounded-xl overflow-hidden border border-gray-200 bg-white p-4 shadow-sm hover:shadow-md transition-all">
              <div className="flex items-center gap-3 min-w-0 w-full min-h-[64px]">
                ...
                <div className="min-w-0 flex-1 basis-0 flex flex-col justify-center space-y-0.5">
                  ...
                  <p className="font-medium leading-tight whitespace-normal sm:whitespace-nowrap sm:truncate" style={{ overflowWrap: "anywhere" }} title="ops@prabasamudralogistics.com">ops@prabasamudralogistics.com</p>
                </div>
              </div>
            </a>
          </div>
